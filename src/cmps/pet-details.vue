			...
			<div v-if="pet.imgUrl" class="pet-details-pic-grid">
				<article class="article-img-1">
					<img
						...
						:src="
							require('@/assets/images/animal/' + petImg1)
						"
					/>
				</article>
				<article class="article-img-2">
					<img
						...
						:src="
							require('@/assets/images/animal/' + petImg2)
						"
					/>
				</article>
				<article class="article-img-3">
					<img
						...
						:src="
							require('@/assets/images/animal/' + petImg3)
						"
					/>
				</article>
			</div>
